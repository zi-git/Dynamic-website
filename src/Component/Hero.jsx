      ...
      <div className="h-[auto] w-[100vw] bg-linear-[0deg,black,#00093f,#000939_80%,black] pt-50 font-['Segoe UI', 'Roboto', 'Helvetica Neue', sans-serif]">
        ...
        <div className="h-[auto] flex justify-center items-center gap-10 flex-col mt-10 pb-100">
          ...
          <div className="h-[auto] flex justify-center items-center  gap-10 flex-col sm:w-[90vw] sm:max-w-[1200px] sm:grid sm:grid-cols-3 sm:grid-rows-3">
            <div className=" h-[50vh] w-[80vw] max-w-[350px] bg-[#00000079] rounded-2xl shadow-[0px_0px_10px_indigo] p-[20px] flex flex-col justify-around items-center sm:h-[50vh] sm:w-[auto] sm:max-w-[350px] sm:min-w-[270px]">
              <img
                className=" rotate-x-30 rotate-z-25 h-auto w-[68%] rounded-4xl border-2 border-gray-500 p-5 shadow-[14px_14px_15px_#E34F26ff] "
            ...
            <div className="h-[50vh] w-[80vw] max-w-[350px] bg-[#00000079] rounded-2xl shadow-[0px_0px_10px_indigo] p-[20px] flex flex-col justify-around items-center sm:h-[50vh] sm:w-[auto] sm:col-start-2 sm:col-end-4 sm:max-w-[770px] sm:min-w-[270px] ">
              <img
                className=" rotate-x-30 rotate-z-25 h-[52%] w-[69%] rounded-4xl border-2 border-gray-500 p-3 shadow-[14px_14px_14px_#039BE5ff] "
                src="/src/assets/css.png"
                alt="CSS"
              />
              <h5 className=" text-3xl text-[#039BE5ff] self-start ">CSS</h5>
              <p className=" text-[var(--text-color)]">
            ...
            <div className="h-[50vh] w-[80vw] max-w-[350px] bg-[#00000079] rounded-2xl shadow-[0px_0px_10px_indigo] p-[20px] flex flex-col justify-around items-center sm:h-[50vh] sm:w-[auto]  sm:max-w-[770px] sm:min-w-[270px] sm:col-start-1 sm:row-start-2 sm:col-end-3 ">
              <img
                className=" rotate-x-30 rotate-z-25 h-auto w-[70%] rounded-4xl border-2 border-gray-500 p-3 shadow-[14px_14px_14px_#F4E11Eff] "
                src="/src/assets/js.png"
                alt="JavaScript"
              />
              <h5 className=" text-3xl text-[#F4E11Eff] self-start ">
                JavaScript
              </h5>
              <p className=" text-[var(--text-color)]">
            ...
            <div className="h-[55vh] w-[80vw] max-w-[350px] bg-[#00000079] rounded-2xl shadow-[0px_0px_10px_indigo] p-[20px] flex flex-col justify-around items-center sm:h-[50vh] sm:w-[30vw] sm:max-w-[330px] sm:min-w-[270px] ">
              <img
            ...
            <div className=" h-[50vh] w-[80vw] max-w-[350px] bg-[#00000079] rounded-2xl shadow-[0px_0px_10px_indigo] p-[20px] flex flex-col justify-around items-center sm:h-[50vh] sm:w-[auto] sm:max-w-[1200px] sm:min-w-[270px] sm:col-span-3 sm:col-start-1 sm:row-start-3 sm:col-end-4 ">
