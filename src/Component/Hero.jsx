          ...
          <div className="h-[auto] flex justify-center items-center  gap-10 flex-col sm:w-[90vw] sm:max-w-[1200px] sm:grid sm:grid-cols-3 sm:grid-rows-3 ">
            <div className=" h-[50vh] w-[80vw] max-w-[350px] bg-[#00000079] rounded-2xl shadow-[0px_0px_10px_indigo] p-[20px] flex flex-col justify-around items-center sm:h-[50vh] sm:w-[auto] sm:max-w-[350px] sm:min-w-[270px]">
              <img
                ...
                alt="HTML"
              />
              <h5 className="text_scale_effect text-3xl text-[#E34F26ff] self-start ">HTML</h5>
            ...
            <div className="left_to_right  h-[50vh] w-[80vw] max-w-[350px] bg-[#00000079] rounded-2xl shadow-[0px_0px_10px_indigo] p-[20px] flex flex-col justify-around items-center sm:h-[50vh] sm:w-[auto] sm:col-start-2 sm:col-end-4 sm:max-w-[770px] sm:min-w-[270px] ">
              <img
            ...
            <div className="bottom_to_top h-[50vh] w-[80vw] max-w-[350px] bg-[#00000079] rounded-2xl shadow-[0px_0px_10px_indigo] p-[20px] flex flex-col justify-around items-center sm:h-[50vh] sm:w-[auto]  sm:max-w-[770px] sm:min-w-[270px] sm:col-start-1 sm:row-start-2 sm:col-end-3 ">
              <img
